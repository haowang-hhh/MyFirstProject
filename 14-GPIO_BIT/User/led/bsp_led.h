...
#define LED_G(a)  \
        if (a) GPIO_ResetBits(LED_G_GPIO_PORT, LED_G_GPIO_PIN); \
        else GPIO_SetBits(LED_G_GPIO_PORT, LED_G_GPIO_PIN);
#define LED_B(a)  \
        if (a) GPIO_ResetBits(LED_B_GPIO_PORT, LED_B_GPIO_PIN); \
        else GPIO_SetBits(LED_B_GPIO_PORT, LED_B_GPIO_PIN);
#define LED_R(a)  \
        if (a) GPIO_ResetBits(LED_R_GPIO_PORT, LED_R_GPIO_PIN); \
